...
class PersonEntityRevisionRevertForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new PersonEntityRevisionRevertForm.
   *
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage(t('Person %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\rw_people\Entity\PersonEntityInterface $revision
